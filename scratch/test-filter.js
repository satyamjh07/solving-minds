// A quick verification test for the word filter.
const { hasExplicitContent } = require('../src/lib/wordFilter');

const testCases = [
  { title: "Normal post title", content: "I am having doubts in organic chemistry, specifically electrophiic addition.", expected: false },
