    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a10] p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-xl relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-[family-name:var(--font-bebas)] tracking-wider text-white">
            CALIBRATE YOUR IDENTITY
          </h1>
          <p className="text-sm text-white/40 max-w-sm mx-auto mt-2">
        ...
        {/* Onboarding Card */}
        <div className="bg-[#111118]/80 backdrop-blur-xl border border-white/[0.07] rounded-3xl p-8 shadow-2xl relative overflow-hidden">
          ...
          {step === 1 && (
            <div className="space-y-8 animate-fade-in">
              <div className="text-center">
                ...
                <p className="text-xs text-white/40">Select a pre-calibrated node or upload a custom image transmission.</p>
              </div>
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="relative group">
                  <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-[#ffffff15] bg-[#ffffff03] flex items-center justify-center relative shadow-lg shadow-black/40">
                    {avatarUrl ? (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/[0.03] border border-white/[0.07] rounded-xl pl-11 pr-4 py-3.5 text-sm text-white placeholder-white/20 focus:outline-none focus:border-[#00f0ff]/40 focus:ring-1 focus:ring-[#00f0ff]/20 transition-all"
                  />
                </div>
              </div>
          ...
          {step === 2 && (
            <div className="space-y-6 animate-fade-in">
              <div className="text-center">
                <h3 className="text-lg font-bold text-white mb-1">Academic Credentials</h3>
                <p className="text-xs text-white/40">Select your active education credentials for optimal dashboard calibration.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full bg-white/[0.03] border border-white/[0.07] rounded-xl px-4 py-3 text-sm text-white placeholder-white/20 focus:outline-none focus:border-[#7c3aed]/40 transition-all resize-none"
                  />
                </div>
              </div>
              ...
              <div className="flex gap-4 pt-2">
                <button
                  onClick={() => setStep(1)}
                  className="px-6 py-4 rounded-xl border border-white/10 hover:bg-white/5 active:scale-[0.98] text-white font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-2 transition-all"
                >
